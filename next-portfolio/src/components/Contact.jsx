      ...
      <div className="flex flex-col items-center gap-12 px-8">
        ...
        <div className="flex flex-col gap-4 items-center">
          <div className="flex gap-5 items-center">
            ...
            <h2 className="font-semibold text-4xl text-gray-900 dark:text-gray-50">tom@pinecone.mn</h2>
            <CopyIcon text="tom@pinecone.mn" theme={theme}/>
          </div>
          <div className="flex gap-5 items-center">
            <PhoneIcon theme={theme} />
            <h2 className="font-semibold text-4xl text-gray-900 dark:text-gray-50">+976 88112233</h2>
